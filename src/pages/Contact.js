...
const Contact = () => {
  return (
    <div className="bg-gray-800 text-gray-100 mt-10 max-h-full flex justify-center items-center">
      <div
        ...
        <div className="">
          <div>
            ...
            <input className="w-full text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          ...
          <div className="mt-8">
            ...
            <textarea
              className="w-full h-32 resize-none text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          </div>
          <div className="mt-8">
            <button
